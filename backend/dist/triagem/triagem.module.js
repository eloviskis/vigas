...
exports.TriagemModule = TriagemModule = __decorate([
    (0, common_1.Module)({
        imports: [typeorm_1.TypeOrmModule.forFeature([triagem_entity_1.Triagem, chamado_entity_1.Chamado]), chamado_module_1.ChamadoModule, profissional_module_1.ProfissionalModule],
        providers: [triagem_service_1.TriagemService],
        controllers: [triagem_controller_1.TriagemController],
        exports: [triagem_service_1.TriagemService],
    })
], TriagemModule);
