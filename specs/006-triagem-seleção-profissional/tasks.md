...
# Tasks: Triagem & Seleção de Profissional com Recomendação Automática

**Input**: docs em `/specs/006-triagem-seleção-profissional/`
...
## Phase 2: User Story US2 - Triagem Automática (Priority: P1) 🎯
...
## Phase 2: User Story US1 - Cadastro de Profissional (Priority: P1) 🎯
...
## Phase 2: User Story US4 - Score e Rating de Profissional (Priority: P2) 
